...
export default function Values() {
  return (
    <div className="mx-auto max-w-7xl p-6 bg-white">
      ...
      <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base/7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
        <div>
          ...
          <dd className="mt-1 text-gray-600">
            We believe in helping every student unlock their potential, whether
        ...
        <div>
          <dt className="font-semibold text-gray-900">Community and Respect</dt>
          <dd className="mt-1 text-gray-600">
        ...
        <div>
          ...
          <dd className="mt-1 text-gray-600">
            Jiu Jitsu is a journey, and we are here to support you every step of
            the way as you grow and evolve.
          </dd>
        </div>
      </dl>
    </div>
